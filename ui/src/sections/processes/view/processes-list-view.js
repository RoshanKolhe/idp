...
export default function ProcessesListView() {
  ...
  const createProcess = useBoolean();
  ...
  const { processess, processessLoading, processessEmpty, refreshProcessess } = useGetProcesses();
  ...
  return (
    <>
      ...
      <ProcessesCreateForm open={createProcess.value} onClose={createProcess.onFalse} />
    </>
  );
}
