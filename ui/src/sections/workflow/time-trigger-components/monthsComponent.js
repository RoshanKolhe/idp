...
export default function MonthsComponent() {
                    ...
                    InputProps={{
                        endAdornment: (
                            <InputAdornment position="end">
                                <Tooltip title="Would run every month unless specified otherwise">
                                    <IconButton edge="end">
            ...
            <Grid item xs={12} md={6}>
                <RHFTextField
                    ...
                    InputProps={{
                        endAdornment: (
                            <InputAdornment position="end">
                                <Tooltip title="The day of the month to trigger (1-31)">
                                    <IconButton edge="end">
                                        <Iconify icon="mdi:information-outline" fontSize="small" />
                                    </IconButton>
                                </Tooltip>
