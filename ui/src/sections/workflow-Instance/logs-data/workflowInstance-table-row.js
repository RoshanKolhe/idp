  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <Tooltip title={workflowInstances.workflowInstanceName} placement="top" arrow>
          <TableCell sx={{ whiteSpace: 'nowrap', maxWidth: 200, textOverflow: 'ellipsis', overflow: 'hidden' }}>{workflowInstances.workflowInstanceName}</TableCell>
        </Tooltip>
        ...
        <TableCell sx={{ px: 1, whiteSpace: 'nowrap', display: 'flex', gap: '10px', justifyContent: 'end' }}>
          <Tooltip title="View logs" placement="top" arrow>
            <IconButton
              ...
              onClick={() => navigate(paths.dashboard.workflowInstance.executionFlow(row.workflowInstances.workflowId, row.workflowInstancesId, row.id))}
            >
...
WorkflowInstanceTableRow.propTypes = {
